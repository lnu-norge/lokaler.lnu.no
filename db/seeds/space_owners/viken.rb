...
viken = SpaceOwner.create_or_find_by(
  title: 'Viken fylkeskommune',
  orgnr: '921693230'
)
viken.how_to_book = '<p>Viken fylkeskommune krever at du annekterer
...
leverer til statsministerens kontor, så vil bli kontaktet./p>',
                    viken.pricing = "<p>Lokale organisasjoner kan få det gratis.</p>
...
viken.who_can_use = '<p>Alle frivillige organisasjoner
