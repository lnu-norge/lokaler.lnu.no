...
class SpaceTypesController < AdminController
  ...
  def create
    ...
    if @space_type.save
      redirect_to space_types_path, notice: "Space type was successfully created."
    else
      render :new
    end
  end
  ...
  def update
    if @space_type.update(space_type_params)
      redirect_to space_types_path, notice: "Space type was successfully updated."
    else
      render :edit
    end
  end
  ...
  def destroy
    @space_type.destroy
    redirect_to space_types_path, notice: "Space type was successfully destroyed."
  end
